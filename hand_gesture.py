...
def is_hand_sideways(hand):
    wrist = hand.landmark[0]  # Wrist landmark
    middle_mcp = hand.landmark[9]  # Middle finger MCP landmark

    return abs(wrist.x - middle_mcp.x) > abs(wrist.y - middle_mcp.y)  # Adjust threshold as needed
